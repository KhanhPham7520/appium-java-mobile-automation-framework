...
import com.automate.utils.configs.PropertyUtils;
...
public final class FrameworkConstants {
    ...
    public static final String ANDROID_APK_PATH =
            TEST_RESOURCES_DIR + File.separator + "app" + File.separator + "Android.SauceLabs.Mobile.Sample.app.2.7.1.apk";
    ...
    public static final String WINDOWS_APPIUM_JS_PATH = System.getenv("APPIUM_HOME") + File.separator + "main.js";

    public static final String MAC_OS_APPIUM_JS_PATH = System.getProperty("appiumJS") + File.separator + "main.js";
